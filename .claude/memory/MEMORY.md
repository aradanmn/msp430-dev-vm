...
## User
- [user_learning_goals.md](user_learning_goals.md) — Scott wants to design embedded systems from scratch, not follow recipes
...
- [project_vector_table_fix.md](project_vector_table_fix.md) — Vector table was wrong in all files; correct CC0=0xFFF2, verify against TI linker script
- [project_course_redesign_complete.md](project_course_redesign_complete.md) — Course redesign L01–L06 complete, concept-driven format
