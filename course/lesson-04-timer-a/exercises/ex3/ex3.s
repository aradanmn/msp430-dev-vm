...
change_speed:
	...
	; check current state
;	cmp.w	#SPD_STATE0,		R8	; if R8 = 0
;	jeq	.Lchg_speed0
;	cmp.w	#SPD_STATE1,		R8	; if R8 = 1
;	jeq	.Lchg_speed1
;	cmp.w	#SPD_STATE2,		R8	; if R8 = 2
;	jeq	.Lchg_speed2
;	cmp.w	#SPD_STATE3,		R8	; if R8 = 3
;	jeq	.Lchg_speed3
;	ret	
;.Lchg_speed0:
;	mov.w	#SPD_STATE1,		R8	; change R8 = 1
;	call	#apply_speed			; update counter
;	ret
;.Lchg_speed1:
;	mov.w	#SPD_STATE2,		R8	; change R8 = 2
;	call	#apply_speed			; update counter
;	ret
;.Lchg_speed2:
;	mov.w	#SPD_STATE3,		R8	; change R8 = 3
;	call	#apply_speed			; update counter
;	ret
;.Lchg_speed3:
;	mov.w	#SPD_STATE0,		R8	; change R6 = 0
	inc.w	R8
